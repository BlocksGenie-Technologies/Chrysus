...
import { eco, searchshoe } from "../../assets";
      ...
      <div className="flex-1 mr-2">
        <div className="flex items-center justify-between">
          ...
          <div className="relative inline-block group">
            ...
            {showFilter && (
              <div
                className="absolute z-50  space-y-2 bg-gray-200 border border-gray-300 w-[200px] max-h-96 top-full right-0 left-0 rounded-md"
          ...
          <div className="relative inline-block group">
            ...
            {showSortDropdown && (
              <div
                className="absolute z-50 space-y-2 bg-gray-200 border border-gray-300 w-[200px] max-h-96 top-full right-0 rounded-md"
                style={{ backdropFilter: "blur(10px)" }}
              >
                {/* Dropdown options */}
        ...
        <div className="flex flex-wrap ">
          {data.map((item, index) => (
            <div className="w-full md:w-1/2 lg:w-1/4 xl:w-1/4 p-2 " key={index}>
              <div className="bg-white rounded-md coustom-box-shadow ">
