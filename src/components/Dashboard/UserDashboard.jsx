              ...
              <div className="row sp20 mb-2 align-items-center">
                <div className="col-xxl-12 d-flex flex-wrap justify-content-between align-items-center">
                  <div className="px-2 info-group  text-center">
                    <h6 className="fs-14 mb-1 font-[700] text-transparent bg-clip-text bg-gradient-to-b from-[#846424] to-[#EDC452] font-montserrat">
                      Liquidation Ratio
                    </h6>
            ...
            <div className="card-body pt-4">
              <div className="w-100">
                <div className="d-flex flex-row justify-content-start align-items-center w-100">
                  <h4 className="text-transparent bg-clip-text bg-gradient-to-b from-[#846424] to-[#EDC452] font-montserrat">
                    Wallet Balances
                  </h4>
                </div>
                <table
            ...
            <div className="card-body pt-4">
              <div className="w-100">
                <div className="d-flex flex-row align-items-center justify-content-between mb-3">
                  <h4 className="m-0 text-transparent bg-clip-text bg-gradient-to-b from-[#846424] to-[#EDC452] font-montserrat">
                    Price Feeds
                  </h4>
                </div>
              ...
              <div className="row sp20 mb-2 align-items-center">
                <div className="col-xxl-12 d-flex flex-wrap justify-content-between align-items-center">
                  <div className="flex flex-col xs:gap-0 gap-3 xs:flex-row justify-between w-100 items-center">
                    ...
                    <h5 className="m-0 text-white">799444.00 CGOV</h5>

                    <button
                      className="font-poppins font-[600] bg-gradient-to-b from-[#846424] to-[#EDC452]"
                      style={{
                        color: "#000000",
                        padding: "10px 25px",
                        fontSize: "12px",
                      ...
                      >
                        ...
                        >
                          <thead>
                            ...
                            >
                              <th className="text-[#B79841] font-poppins">
                                Date
                              </th>
                              <th className="text-[#B79841] font-poppins">
                                Action
                          ...
                          <tbody className="text-white">
                            {currentTransactions.length == 0 ? (
                              <tr className="text-[#B79841]">Loading...</tr>
                            ) : (
