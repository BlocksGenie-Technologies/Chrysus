...
import { postblog, pic1, SendDarkIcon } from "../assets";
...
const blocardList = [
  { image: postblog, image2: postblog, title: "Featured Blog" },
];
          ...
          <div className=" flex  max-[800px]:flex-col max-[800px]:items-center gap-3 justify-center  ">
            <div className="sm:w-[50%] xl:w-[100%] flex items-center justify-between  ">
              <div className="flex flex-col w-[100%]">
                ...
                <p className="text-[#EDC452] font-[300] text-[16px] leading-[24px] ">
                  ...
                  <div className="mb-8" key={index}>
                    <div className="dz-card max-w-[596px] w-[100%] style-1 flex lg:flex-row flex-col gap-3 items-center bg-gradient-to-b from-[#151515] to-[#323232] p-4 rounded-lg ">
                      ...
                      <div className="flex flex-col gap-[5px]">
                        <h4 className="text-yellow-500 text-2xl font-semibold  ">
                        ...
                        <span className="text-[#EDC452] mb-2 leading-[12.19px] text-[12px] font-[600] font-montserrat">
                          7 April, 2022
                        </span>
                        <div>
                          <a
                            style={{ color: "#846424" }}
                            target="_blank"
                            href="https://medium.com/@chrysus_coin/how-chc-could-shape-the-future-of-stablecoins-cash-flow-generation-9685b1e43655"
                          >
