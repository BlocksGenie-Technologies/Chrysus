  ...
  >
    <div className={`${styles.flexStart} md:flex-row flex-col w-full`}>
      <div className="flex-1 flex flex-col justify-start  mt-3 ">
        ...
        />
        {/* lg:w-[380px] w-[220px] */}
        <div className="border-t-[1px] border-t-[#846424] w-[100%] max-w-[380px] flex flex-wrap  mt-[20px]">
          <p
            className={`${styles.paragraph} mt-3  font-montserrat text-[14px]`}
          >
            Engineered with excellence by <b> BlocksGenie Technologies</b>
          </p>
        </div>
      </div>
      ...
      <div className="flex-[1.5px] w-full flex flex-row justify-between flex-wrap md:mt-0 mt-10 ">
        {footerLinks.map((footerLink, index) => (
          ...
          >
            <h4 className="font-poppins font-[500] text-[14px] leading-[16px] text-[#EDC452]">
              {footerLink.title}
            </h4>
    ...
    <div className="w-full flex justify-between items-center md:flex-row flex-col py-6 border-t-[1px] border-t-[#846424]">
      <p className="font-poppins font-normal text-center text-[14px] leading-[25.07px] text-white mb-0 opacity-[70%]">
        Copyright Ⓒ 2022 - 2024 <span className="text-[#EDC452]"> Chrysus</span>
        , All Rights Reserved.
      </p>
