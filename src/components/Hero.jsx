...
const Hero = () => {
  ...
  return (
    // md:h-screen lg:h-[50%]
    <div className=" bg-[url('./assets/bg-hero.png')] md:bg-cover sm:bg-auto h-screen  ">
          ...
          <section className=" fixed inset-0 flex justify-center items-center bg-black bg-opacity-50">
            <div className="modal__align  ">
              <div className="modal__content relative bg-gradient-to-l from-[#846424] to-[#EDC452] p-1 rounded-md shadow-lg z-10">
                {/* <button
                  className="absolute border-2 border-[#EDC452] rounded-lg p-1 top-0 right-0 mb-4 text-[#EDC452] hover:text-[white]"
                ...
                <div className="modal__video-align">
                  {/* {videoLoading ? (
                    <div className="modal__spinner">loading</div>
                  ) : null} */}
        ...
        >
          ...
          >
            <div className="flex flex-row justify-between flex-wrap items-center w-full">
              <h1 className="min-[2000px]:text-[86px] min-[2000px]:leading-[86px] flex flex-col lg:items-start    md:items-center xl:items-center  text-gradient flex-1 font-montserrat font-semibold  lg:text-[64px] text-[40px] lg:leading-[75px] leading-[42px]">
                Decentralized
