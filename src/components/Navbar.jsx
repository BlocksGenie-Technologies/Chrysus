...
import { close, brightlogo, menu, newWallet } from "../assets";
      ...
      <nav className="relative w-full  flex flex-row  items-center  lg:py-6 py-2 justify-between overflow-hidden lg:items-center ">
        ...
        <div>
          <ul className="list-none  sm:flex hidden flex-row gap-[1px] justify-between items-center flex-1 ">
            <li
              className={
                "leading-[16px] font-[400] text-[14px] font-poppins mr-4 cursor-pointer text-baseAssets"
              }
            ...
            {address != undefined ? (
              <li className="leading-[16px] font-[400] text-[14px] ml-4 font-poppins cursor-pointer text-baseAssets">
                <NavLink
            ...
            <div className=" p-3 bg-black-gradient relative  z-[100] w-[300px] right-0 mx-4 my-2 min-w-[300px] rounded-lg sidebar">
              <ul className="list-none  flex  justify-end items-center flex-1 flex-col">
                {navLinks.map((nav, index) => (
                  <li
                    key={nav.path}
                    className={`font-poppins text-[#846424] font-medium cursor-pointer text-[16px] ${
                      active === nav.name ? "text-white" : "text-[#846424]"
                ...
                <li
                  className="text-[#846424] text-[16px] font-poppins cursor-pointer"
